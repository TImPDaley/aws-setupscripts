class User < ApplicationRecord
  ...
  # label used in simple_form_for to display the correct info in dropdowns
  def fullname
    "#{firstname} #{lastname}"
  end
  ...
  def activate
    ...
    UserMailer.activation_confirmation(self).deliver_now
  ...
  # reset_sent_at more than four hours ago
